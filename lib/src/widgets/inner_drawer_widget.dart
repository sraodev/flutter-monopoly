...
class InnerDrawerPage extends StatefulWidget {
  InnerDrawerPage({Key key}) : super(key: key);

  @override
  _InnerDrawerPageState createState() => _InnerDrawerPageState();
}

class _InnerDrawerPageState extends State<InnerDrawerPage> {
